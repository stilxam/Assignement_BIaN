...
top_100_database <- read.csv(file = "C:/Users/Felipe Cintra/Documents/TUE_2223/JBE140-Bussiness Insights and Networks/RTutorials and Quiz/top_100_database.csv", sep = ",")
sdc_database <- read.csv(file = "C:/Users/Felipe Cintra/Documents/TUE_2223/JBE140-Bussiness Insights and Networks/RTutorials and Quiz/sdc_database.csv", sep = ",", quote = "")
...
t.test(data.frame(centrality_old)$closeness, data.frame(centrality_new)$closeness)
